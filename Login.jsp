...
<div class="wrapper row3" style="border:1px solid #00264d;height:auto;background: white;border-radius:10px;">
  <h1 align="center" style="font-size:20px;">Citizen Login Here</h1>
      ...
      <%}%>
                    <table>
                         ...
                         <tr><td><input type="submit" value="Login"> 
                             ...
                             <td><font color="grey">Don't Have An Account? </font><a href="Register.jsp"><font color="red">Register</font></a></td></tr>
                             </table>
                </form>
